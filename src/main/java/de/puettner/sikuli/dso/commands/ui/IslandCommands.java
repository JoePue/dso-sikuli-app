...
public class IslandCommands extends SikuliCommands {
    ...
    public boolean clickSolvedQuestArrow() {
        log.info("clickSolvedQuestArrow");
    ...
    public boolean closeChat() {
        return clickIfExists(pattern("Chat-Close-Icon.png").similar(0.95f).targetOffset(0, -8), appRegion);
    }
